...
public class UserStepDefnition {
	WebDriver driver;
	...
	public void user_enters_username_and_password(DataTable credential) {
	    ...
	    driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys(data.get(0).get(0));;//("//*[@id=\"username\"]")
	...
	public void User_enters_the_firstname_and_lastname_and_email(DataTable values) {
		List<List<String>> data=values.raw();
		driver.findElement(By.xpath("//*[@id=\"userDataLightBox_firstNameField\"]")).sendKeys(data.get(0).get(0));
		driver.findElement(By.xpath("//*[@id=\"userDataLightBox_lastNameField\"]")).sendKeys(data.get(0).get(1));
		driver.findElement(By.xpath("//*[@id=\"userDataLightBox_emailField\"]")).sendKeys(data.get(0).get(2));
	}
